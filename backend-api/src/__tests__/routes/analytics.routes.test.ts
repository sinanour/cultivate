...
describe('AnalyticsRoutes', () => {
    ...
    describe('GET /api/analytics/growth', () => {
        it('should return growth metrics', async () => {
            const mockMetrics = {
                timeSeries: [
                    { period: '2024-01', newParticipants: 10, newActivities: 5, cumulativeParticipants: 10, percentageChange: null },
                    { period: '2024-02', newParticipants: 15, newActivities: 8, cumulativeParticipants: 25, percentageChange: 50 },
                ],
            };
