...
async function main() {
    ...
    const activityTypesWithCategories = [
        ...
        { name: 'Ruhi Book 01', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 02', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 03', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 03A', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 03B', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 03C', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 03D', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 04', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 05', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 05A', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 05B', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 06', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 07', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 08', categoryName: 'Study Circles' },
        { name: 'Ruhi Book 09', categoryName: 'Study Circles' },
